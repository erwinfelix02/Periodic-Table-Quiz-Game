 ...
 * @author Erwin
 */
public class multipleweight extends javax.swing.JFrame {

    /**
     * Creates new form multipleweight
     */
    public multipleweight() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel4.setText("196.97");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel5.setText("26.9");
    ...
    private void TextinputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextinputActionPerformed
        // TODO add your handling code here:
      multiweight  multiweight = new  multiweight();
       multiweight.setLocationRelativeTo(null);//frame in the center
        multiweight.setVisible(true);
        this.dispose(); // close the certain frame
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(multipleweight.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new multipleweight().setVisible(true);
            }
        });
    }
