 ...
 * @author Erwin
 */
public class howtext extends javax.swing.JFrame {

    /**
     * Creates new form howtext
     */
    public howtext() {
        initComponents();
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\Erwin\\Downloads\\logo.png"));
         setBackgroundImage("C:\\Users\\Erwin\\Downloads\\howin.png");
         setLocationRelativeTo(null);//frame in the center
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Welcome to a fun game where you guess the  element, atomic number and atomic weight ");

        jLabel2.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel2.setText(" from the periodic table! That  reveals a hint.  Let's see how well you know your elements");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(howtext.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
