 ...
 * @author Erwin
 */
public class combi_atomic extends javax.swing.JFrame {

    /**
     * Creates new form combi_atomic
     */
    public combi_atomic() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Guess the Compound");
        ...
        jLabel4.setText("Covalent");

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 10)); // NOI18N
        jLabel5.setText("Ionic");
    ...
    private void TextinputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextinputActionPerformed
        // TODO add your handling code here:
         combielement  combielement = new  combielement();
        combielement.setLocationRelativeTo(null);//frame in the center
        combielement.setVisible(true);
        this.dispose();// close the certain frame
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(combi_atomic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new combi_atomic().setVisible(true);
            }
        });
    }
