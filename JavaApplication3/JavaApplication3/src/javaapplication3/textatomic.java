 ...
 * @author Erwin
 */
public class textatomic extends javax.swing.JFrame {

    /**
     * Creates new form textatomic
     */
    public textatomic() {
        initComponents();
    ...
    private void TextinputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_TextinputActionPerformed
        // TODO add your handling code here:
         ...
         atomic.setLocationRelativeTo(null);//frame in the center
         atomic.setVisible(true);
         this.dispose(); // close the certain frame
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(textatomic.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new textatomic().setVisible(true);
            }
        });
    }
